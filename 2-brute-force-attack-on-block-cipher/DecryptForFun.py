...
if len(sys.argv) is not 3: #(B)
    sys.exit("Needs two command-line arguments: one for the encrypted file and the other for the decrypted output file")
...
# outputtext = msg_decrypted_bv.get_bitvector_in_ascii() #(c)
